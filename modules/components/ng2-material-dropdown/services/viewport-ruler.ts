...
/** @docs-private */
export function VIEWPORT_RULER_PROVIDER_FACTORY(parentRuler: ViewportRuler, ngZone: NgZone) {
  return parentRuler || new ViewportRuler(ngZone);
}
...
export const VIEWPORT_RULER_PROVIDER = {
  ...
  deps: [[new Optional(), new SkipSelf(), ViewportRuler], NgZone],
